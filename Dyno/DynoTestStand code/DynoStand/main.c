...
int main(void) {
   ...
   SysCtlPeripheralEnable(SYSCTL_PERIPH_UART2);
	UARTStdioConfig(2, 921600, g_ui32SysClock);
...
while(!ADCIntStatus(ADC0_BASE,0,false)){
	...
	uint32_t DataReturned2 = ADCSequenceDataGet(ADC1_BASE,0,&ADCValue2[0]);
	//UARTprintf("ADC0 = %6d, ADC1 = %6d, Time = %6d, SR %2d\n",ADCValue[1], ADCValue[3],NewTime - OldTime, DataReturned);
	UARTprintf("D1 %4d, D2 %4d, T %3d,\n",ADCValue[0], ADCValue2[0], NewTime - OldTime);
